				...
				<div class="col-lg-12">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__links">
							<a href="./index.html">Home</a> <a href="./shop.html">매장찾기</a> <span>매장등록</span>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="checkout__input">
										...
										<input type="text" id="storeTel" name="storeTel" value="${store.storeTel} ">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="checkout__input">
										...
										<input type="text" id="storeOpen" name="storeOpen" value="${store.storeOpen} ">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="checkout__input">
										...
										<input type="text" id="storeClose" name="storeClose" value="${store.storeClose} ">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-6">
									<div class="checkout__input">
										...
										<input type="text" id="storeLat" name="storeLat" value="${store.storeLat} ">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="checkout__input">
										...
										<input type="text" id="storeLng" name="storeLng" value="${store.storeLng} ">
									</div>
								</div>
							</div>
							<div align="center">
							<input type= submit value = "수정하기" onclick="return form_check()" style="background-color: #469543; color: #fff; border-radius: 30px; padding: 10px 20px; border: none; margin: 0 auto;">
								<button type="submit" onclick="location.href='/store/list'" style="background-color: #469543; color: #fff; border-radius: 30px; padding: 10px 20px; border: none; margin: 0 auto;">목록보기</button>
							</div>
