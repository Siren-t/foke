...
<div class="container" style="padding-top: 100px; padding-bottom: 100px;">
    <h4 class="checkout__title" style="margin-bottom: 50px;">이용약관</h4>
  	<div class="row">
    	<div class="col-12">
제 1 장 총칙<br>
<br>
제 1 조 (목적)<br>
본 약관은 ○○○이 운영하는 웹 사이트 (http://xxx.xxx.xxx)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.<br>
<br>
제 2 조 (용어의 정의)<br>
